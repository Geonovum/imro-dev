...
<!-- TESTBESTAND
	  ...
	  TESTCASE: 		BESTEMMINGSPLAN met planstatus CONCEPT per 01-01-2026 blokkeren, tenzij naam begint met 'TAM-omgevingsplan[spatie]'
  	TESTINPUT:		<imro:planstatus> = 'concept' && <imro:datum>2026-01-01</imro:datum> && <imro:naam>Raadhuisstaete Spijkenisse</imro:naam>
