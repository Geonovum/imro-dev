...
<!-- TESTBESTAND
	  ...
	  TESTCASE: 		BESTEMMINGSPLAN met planstatus VOORONTWERP per 01-01-2026 blokkeren, ook als naam begint met 'TAM-omgevingsplan[spatie]'
  	TESTINPUT:		<imro:planstatus> = 'voorontwerp' && <imro:datum>2026-01-01</imro:datum> && <imro:naam>TAM-omgevingsplan Raadhuisstaete Spijkenisse</imro:naam>	
