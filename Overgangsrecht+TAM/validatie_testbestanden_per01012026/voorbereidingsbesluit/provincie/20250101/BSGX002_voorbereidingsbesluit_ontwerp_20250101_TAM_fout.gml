...
<!-- TESTBESTAND
  	...
  	TESTINPUT:		<beleidsmatigVerantwoordelijkeOverheid> = 'provinciale overheid' && <imro:planstatus> = ontwerp && <imro:datum> = 2025-01-01 &&  <imro:naam> = 'TAM-voorbereidingsbesluit Voorbereidingsbesluit Bronbeeklaan 66'	  	
