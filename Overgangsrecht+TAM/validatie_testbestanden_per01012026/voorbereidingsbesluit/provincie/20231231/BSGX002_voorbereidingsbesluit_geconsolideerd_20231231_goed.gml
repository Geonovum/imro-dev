...
<!-- TESTBESTAND
	  ...
	  TESTCASE: 		VOORBEREIDINGSBESLUIT van PROVINCIE vóór 2024-01-01 toestaan
  	TESTINPUT:		<beleidsmatigVerantwoordelijkeOverheid> = 'provinciale overheid' && <imro:planstatus> = geconsolideerd && <imro:datum> = 2023-12-31  	
